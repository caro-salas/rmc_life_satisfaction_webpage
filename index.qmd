...
author: "Carola Salas" # Remember to add your name!
...
cantril_filter <- cantril %>% 
  filter (Country %in% c("Peru", "Kenya" , "Thailand", "Australia", "Austria"))

happy_plot <- ggplot(cantril_filter, aes(x = Year, y = `Cantril ladder score`, col = Country)) +
  geom_line() +
  scale_y_continuous(limits = c(0, 10)) +
  labs(
    title = "Line Graph for Happiness in Selected Countries",
    x = "Year",
